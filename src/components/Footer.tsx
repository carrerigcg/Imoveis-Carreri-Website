...
02221-000<br />
          ...
          <div>
            ...
            <Button variant="secondary" size="lg" onClick={() => window.open("https://wa.me/5511931474718?text=" + encodeURIComponent("Olá, gostaria de agendar uma visita para conhecer um imóvel da Imóveis Carreri."), "_blank")} className="w-full gap-2">
